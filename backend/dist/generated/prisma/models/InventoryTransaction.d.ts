...
export type InventoryTransactionMinAggregateOutputType = {
    ...
    item_id: string | null;
    user_id: string | null;
    transaction_type: $Enums.InventoryTransactionType | null;
    quantity: number | null;
...
export type GetInventoryTransactionAggregateType<T extends InventoryTransactionAggregateArgs> = {
    [P in keyof T & keyof AggregateInventoryTransaction]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateInventoryTransaction[P]> : Prisma.GetScalarType<T[P], AggregateInventoryTransaction[P]>;
};
...
export type GetInventoryTransactionGroupByPayload<T extends InventoryTransactionGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<InventoryTransactionGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof InventoryTransactionGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], InventoryTransactionGroupByOutputType[P]> : Prisma.GetScalarType<T[P], InventoryTransactionGroupByOutputType[P]>;
}>>;
export type InventoryTransactionWhereInput = {
    ...
    transaction_id?: Prisma.StringFilter<"InventoryTransaction"> | string;
    item_id?: Prisma.StringFilter<"InventoryTransaction"> | string;
    user_id?: Prisma.StringFilter<"InventoryTransaction"> | string;
    transaction_type?: Prisma.EnumInventoryTransactionTypeFilter<"InventoryTransaction"> | $Enums.InventoryTransactionType;
    quantity?: Prisma.IntFilter<"InventoryTransaction"> | number;
    transaction_date?: Prisma.DateTimeFilter<"InventoryTransaction"> | Date | string;
...
export type InventoryTransactionScalarWhereWithAggregatesInput = {
    ...
    transaction_id?: Prisma.StringWithAggregatesFilter<"InventoryTransaction"> | string;
    item_id?: Prisma.StringWithAggregatesFilter<"InventoryTransaction"> | string;
    user_id?: Prisma.StringWithAggregatesFilter<"InventoryTransaction"> | string;
    transaction_type?: Prisma.EnumInventoryTransactionTypeWithAggregatesFilter<"InventoryTransaction"> | $Enums.InventoryTransactionType;
    quantity?: Prisma.IntWithAggregatesFilter<"InventoryTransaction"> | number;
    transaction_date?: Prisma.DateTimeWithAggregatesFilter<"InventoryTransaction"> | Date | string;
};
...
export type InventoryTransactionUpdateInput = {
    ...
    transaction_type?: Prisma.EnumInventoryTransactionTypeFieldUpdateOperationsInput | $Enums.InventoryTransactionType;
...
export type InventoryTransactionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"transaction_id" | "item_id" | "user_id" | "transaction_type" | "quantity" | "transaction_date", ExtArgs["result"]["inventoryTransaction"]>;
...
export type InventoryTransactionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<InventoryTransactionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface InventoryTransactionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const inventoryTransactionWithTransaction_idOnly = await prisma.inventoryTransaction.findMany({ select: { transaction_id: true } })
     *
     */
     ...
     * })
     *
     * // Create many InventoryTransactions and only return the `transaction_id`
     * const inventoryTransactionWithTransaction_idOnly = await prisma.inventoryTransaction.createManyAndReturn({
     ...
     * })
     *
     * // Update zero or more InventoryTransactions and only return the `transaction_id`
     * const inventoryTransactionWithTransaction_idOnly = await prisma.inventoryTransaction.updateManyAndReturn({
     *   select: { transaction_id: true },
     *   where: {
     *     // ... provide filter here
     *   },
     ...
     * })
    **/
    count<T extends InventoryTransactionCountArgs>(args?: Prisma.Subset<T, InventoryTransactionCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], InventoryTransactionCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends InventoryTransactionGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, InventoryTransactionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetInventoryTransactionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface InventoryTransactionFieldRefs {
    readonly transaction_id: Prisma.FieldRef<"InventoryTransaction", 'String'>;
    readonly item_id: Prisma.FieldRef<"InventoryTransaction", 'String'>;
    readonly user_id: Prisma.FieldRef<"InventoryTransaction", 'String'>;
    readonly transaction_type: Prisma.FieldRef<"InventoryTransaction", 'InventoryTransactionType'>;
    readonly quantity: Prisma.FieldRef<"InventoryTransaction", 'Int'>;
    readonly transaction_date: Prisma.FieldRef<"InventoryTransaction", 'DateTime'>;
}
/**
